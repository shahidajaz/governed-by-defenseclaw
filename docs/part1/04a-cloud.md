---
title: "Step 4A — Track A: Cloud"
---

# Step 4A — Track A: Cloud

The fastest path. The cloud provider is recognised automatically, and DefenseClaw needs no endpoint configuration.
